...
from segearth_r1.constants import IGNORE_INDEX
...
def train():
    ...
    model_args = ModelArguments(
        model_name_or_path="/opt/data/private/SegEarth-R1-main/pre_trained/phi-1_5_dev",
        version="llava_phi",
        vision_tower="/opt/data/private/SegEarth-R1-main/pre_trained/Swin_base/model_final_9d7f02.pkl",
    ...
    data_args = DataArguments(
        data_path="/opt/data/private/data_set/farmseg",  # 请根据实际数据路径修改
        lazy_preprocess=True,
        dataset_type="RefSegRS",
        segmentation=True
    )
...
if __name__ == "__main__":
    ...
    print("开始训练...")
    print("请确保数据路径正确: data_path")
    print("模型将保存到: ./checkpoint/SegEarth-R1_ReasonSeg")
